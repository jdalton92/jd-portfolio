    ...
    <>
      <div className="about-block sdlc-contect">
        ...
        <ul className="about-block-content">
          <li>
            Directly contributed to building a bespoke prototype integrated CRM
            / database web application for the CBRE's Australia and New Zealand
            business (1000+ employees)
          </li>
          <li>
            Gained insight into large-scale commercial software development and
            worked directly with in house softwar developers in created detailed
            user stories, and testing user scripts
          </li>
          <li>
        ...
        <h5 className="about-subheader-2">Development, Testing, Deployment</h5>
        <ul className="about-block-content">
          <li>
          ...
          <li>
            Sole creater/owner of bespoke responsive full stack single page web
            applications built with modern tech stack, deploying via Heroku,
            Digital Ocean, and AWS. Refer to my{" "}
